...
const Signup = () => {
  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    try {
      ...
      setError(err.message || "Google sign-up failed. Please use email/password signup or configure Google OAuth in Google Cloud Console.");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleGoogleError = () => {
    setError("Google sign-up failed. Please use email/password signup instead.");
  };
